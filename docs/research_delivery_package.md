...
| 机制主表 | `evidence_tier=core` 的 CMA 假说 | H1 证据不足，H5 支持，H7 支持；H7 另有行业交互回归补强 | `results/real_tables/cma_hypothesis_verdicts.csv`、`cma_h7_sector_interaction.csv` |
...
H2 的证据状态要单独说明：`data/raw/passive_aum.csv` 当前只有 US 年度被动 AUM
序列，缺少 CN 可比被动 AUM，所以 dashboard/evidence manifest 会显示 warn；
它不能写成“中美被动资金差异已被验证”。
...
| 为什么不是被动基金生效日买盘？ | 生效日 CAR 不显著，且 H2 为 supplementary、n=12；当前只有 US AUM，缺少 CN 可比 AUM。当前更支持公告期定价与制度机制解释。 |
