...
| 2026-05-03 | 样本边界扩展 | HS300 RDD L3 从 6 批次扩到 11 批次（新增 csi300-2020-11、2021-05、2021-11、2022-05、2022-11，共 197 行）。来源：中证官方 Excel 公告附件原本有 `备选名单` sheet（含 `排序` 列），原 parser 漏读；修正后无需手工 archive 检索。仍 < 20 批次 / 10 年门槛，主表用法不变。verdicts diff vs 基线快照：0 changed。 | §3 仅 RDD 行；§4 不变 | 2026-05-03 leo | _待填_ |
