...
![CLI](https://img.shields.io/badge/CLI-37%20commands-2da44e)
...
4. [docs/cli_reference.md](docs/cli_reference.md)：37 个 console scripts 的完整说明。
...
- 总入口：`rebuild-all` / `verdict-summary` / `doctor` / `export-public-summary`
