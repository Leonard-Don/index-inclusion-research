...
def test_compute_retention_summary_reports_reversal_and_ratio() -> None:
    event_level = pd.DataFrame(
        [
            {"event_id": "a", "market": "US", "event_phase": "announce", "inclusion": 1, "treatment_group": 1, "car_p0_p20": 0.10, "car_p0_p120": 0.04},
            {"event_id": "b", "market": "US", "event_phase": "announce", "inclusion": 1, "treatment_group": 1, "car_p0_p20": 0.06, "car_p0_p120": 0.03},
        ]
    )
...
def test_compute_did_summary_compares_treated_and_control_changes() -> None:
    panel = pd.DataFrame(
        [
            {"event_id": "t1", "matched_to_event_id": "g1", "market": "CN", "event_phase": "announce", "inclusion": 1, "treatment_group": 1, "relative_day": -1, "ar": 0.01, "turnover": 0.02, "volume": 100},
            {"event_id": "t1", "matched_to_event_id": "g1", "market": "CN", "event_phase": "announce", "inclusion": 1, "treatment_group": 1, "relative_day": 1, "ar": 0.05, "turnover": 0.03, "volume": 130},
            {"event_id": "c1", "matched_to_event_id": "g1", "market": "CN", "event_phase": "announce", "inclusion": 1, "treatment_group": 0, "relative_day": -1, "ar": 0.00, "turnover": 0.02, "volume": 100},
            {"event_id": "c1", "matched_to_event_id": "g1", "market": "CN", "event_phase": "announce", "inclusion": 1, "treatment_group": 0, "relative_day": 1, "ar": 0.01, "turnover": 0.02, "volume": 105},
        ]
    )
    summary = compute_did_summary(panel, pre_window=(-1, -1), post_window=(1, 1))
    ar_row = summary.loc[(summary["metric"] == "abnormal_return") & (summary["inclusion"] == 1)].iloc[0]
