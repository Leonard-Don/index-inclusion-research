...
**生成时间**: 2026-05-30 | **裁决基线快照**: 2026-05-16

## 1. 样本规模

| 假说 | 名称 | n_obs | 证据层级 | 主线 |
|---|---|---:|---|---|
| H1 | 信息泄露与预运行 | 455 | core | identification |
| H2 | 被动基金 AUM 差异 | 18 | core | demand_curve |
| H3 | 散户 vs 机构结构 | 4 | supplementary | price_pressure |
| H4 | 卖空约束 | 455 | supplementary | identification |
| H5 | 涨跌停限制 | 1096 | core | identification |
| H6 | 指数权重可预测性 | 87 | supplementary | demand_curve |
...
| 当前偏离 | flipped=2 · tightened=0 · weakened=3 · unverifiable=0 · unchanged=2 |
