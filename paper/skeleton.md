...
公告前均值漂移在中国约 +2.75%，美国约 +2.61%，两市场差异 bootstrap p=1.000。该事实要求论文诚实披露：市场可能在正式公告前已部分消化信息，公告窗显著并不等同于“公告当天才第一次被定价”。这也是本文避免强因果表述的关键原因。
...
- baseline 冻结天数：14
- PAP deviation：unchanged=2，tightened=0，weakened=3，flipped=2，unverifiable=0
