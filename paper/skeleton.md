...
**日期**: 2026-05-29
**摘要**: 摘要待精修：本文围绕指数纳入溢价的信息渠道与需求压力渠道之争，使用中美两市场事件研究、匹配样本回归与机制证据，比较公告日与生效日窗口的异常收益。当前样本覆盖 中国 137 个纳入事件、美国 255 个纳入事件；核心发现是公告窗 CAR 显著为正、生效窗约为零，且中美公告窗量级接近。结果支持“公告阶段信息/认证与制度约束共同定价”的解释，而不支持把纳入溢价主要归因于生效日机械买盘。
...
- 裁决基线日期：2026-05-29
- 裁决基线路径：`snapshots/pre-registration-2026-05-29.csv`
- baseline 冻结天数：待补
