...
DISPLAYED_ARTIFACT_PATHS = {
    ...
    "results/real_figures/cma_verdicts_forest.png",
    "results/real_figures/cma_verdicts_sensitivity.png",
    "results/real_figures/cma_verdicts_ar_engine.png",
    "results/real_figures/cma_verdicts_2d_robustness.png",
    ...
    "results/real_tables/power_analysis_report.csv",
    "results/real_tables/power_analysis_report.md",
...
ARTIFACT_DISPLAY_NAMES = {
    ...
    "cma_verdicts_forest.png": "CMA 裁决稳健性森林图",
    "cma_verdicts_sensitivity.png": "CMA 裁决阈值敏感性图",
    "cma_verdicts_ar_engine.png": "CMA 裁决 AR 引擎对照图",
    "cma_verdicts_2d_robustness.png": "CMA 裁决 2D 稳健性图",
    ...
    "power_analysis_report.csv": "假说功效分析表",
    "power_analysis_report.md": "假说功效分析说明",
