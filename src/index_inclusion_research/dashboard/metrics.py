    ...
    return [
        {
            ...
            "title": "先按阵营读，再按年份读",
            "meta": "统一排序规则",
            "copy": "当前目录已按阵营和年份统一排序，适合从研究史角度把握指数效应争论的演进脉络。",
        },
        {
            "kicker": "深度信息",
            "title": "不只看立场，也看识别对象",
            "meta": "目录已加入识别对象与挑战的假设",
            "copy": "这张总表不只标注文献立场，也说明每篇文献识别了什么、反驳了哪条旧假设。",
        },
    ]
    ...
    return [
        {
            ...
            "title": "重新审视永久效应",
            "meta": "价格压力、动量错觉与效应弱化",
            "copy": "反方文献并不是简单否定指数效应，而是把早期上涨重新解释为短期流动性冲击、纳入前强势表现，或现代市场中被提前交易压缩后的信号。",
        },
        {
            "kicker": "中性文献",
            "title": "争论如何转向识别",
            "meta": "制度差异、套利约束、价格发现与隐性换手成本",
            "copy": "中性文献的重要性不在于表态，而在于说明结论会随指数制度、市场摩擦、识别设计、价格发现条件和被动基金隐性换手成本而改变。",
        },
        {
            "kicker": "正方文献",
            "title": "哪些机制仍然成立",
            "meta": "需求曲线、长期保留与中国证据",
            "copy": "正方文献不只是重复“会涨”，而是在更强设计下继续保留长期保留、信息背书和中国市场不对称证据。",
        },
    ]
...
def build_identification_status_panel(
    ...
    *,
    ...
    if mode == "real":
        next_step_copy = "当前已经进入正式证据链；后续刷新时重点关注候选样本审计、RDD 摘要和图表是否与最新快照保持一致。"
